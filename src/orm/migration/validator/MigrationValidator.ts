...
import { ValidationResult } from '../interfaces/types'
...
export class MigrationValidator {
   ...
   */
  async validate(migration: MigrationInterface, schema: DatabaseSchema): Promise<ValidationResult> {
   ...
   */
  private async checkForExistingData(query: string): Promise<boolean> {
    try {
      const tableName = this.extractTableName(query)
