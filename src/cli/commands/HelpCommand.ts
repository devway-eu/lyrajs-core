  ...
  async execute() {
    LyraConsole.info(
      "                       _             \n" +
        ...
        "                                       \n" +
        " HELP - COMMANDS                       \n",
      "cleanup:backups      \u279E Cleans up old backup files (use --days=N, default: 30 days)",
      ...
      "migration:squash     \u279E Combines multiple migrations into a single baseline migration (use --to=VERSION)",
      "restore:backup       \u279E Restores database from backup (use migration version)",
      "show:backups         \u279E Shows all available backup files in a formatted table",
