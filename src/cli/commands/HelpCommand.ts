...
export class HelpCommand {
  async execute() {
    LyraConsole.info(
      ...
      "make:migration    \u279E Creates new migration containing changes to entities",
      "migration:migrate \u279E Apply last migration to make tables corresponding to entities",
      "fixtures:load     \u279E Loads fixtures data in database",
      "show:controllers  \u279E Shows all controllers",
      "show:entities     \u279E Shows all entities",
      "show:migrations   \u279E Shows all migrations",
