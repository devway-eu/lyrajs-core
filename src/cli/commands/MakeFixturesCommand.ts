...
export class MakeFixturesCommand {
  ...
  async execute(args: string[] = []) {
    ...
    LyraConsole.success(
      ...
      `File: ${filePath}`,
      "",
      "Implement the load() method to define your fixture data.",
      "Use 'fixtures:load' command to load all fixtures."
    )
  }
   ...
   */
  private generateFixtureFile(className: string): string {
    let fixtureContent = ``
