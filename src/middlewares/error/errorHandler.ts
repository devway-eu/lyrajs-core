 ...
 */
export const errorHandler = async (error: HttpExceptionType, req: Request, res: Response, _next?: NextFunction): Promise<void> => {
  ...
  if (!isErrorRoute && (req as any)._server) {
    ...
    if (errorPath) {
      ...
      const server = (req as any)._server;
