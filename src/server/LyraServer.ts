...
class LyraServer {
    ...
    async getControllersAsync(controllersPath: string = 'src/controllers'): Promise<void> {
    ...
    getControllers(controllersPath: string = 'src/controllers'): this {
        return this;
    }
    ...
    // Parse request body
    async parseBody(req: Request): Promise<any> {
