 ...
 */
export function serializeToXML(obj: any, rootName: string = 'root'): string {
    /**
     ...
     */
    function valueToXML(key: string, value: any, indent: number = 0): string {
