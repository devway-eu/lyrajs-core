...
export class FileManager extends Service {
   ...
   */
  private generateUniqueFilename(originalName: string, preserveOriginal = false): string {
   ...
   */
  private validateFile(file: any, options: UploadOptions = {}): { valid: boolean; error?: string } {
   ...
   */
  async uploadFile(file: any, options: UploadOptions = {}): Promise<UploadedFileInfo> {
    // Validate file
   ...
   */
  async uploadFiles(files: any[], options: UploadOptions = {}): Promise<UploadedFileInfo[]> {
